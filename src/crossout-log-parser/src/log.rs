...
fn parse_message<'a, E>(input: &'a str) -> nom::IResult<&'a str, Message, E>
where
    E: nom::error::ParseError<&'a str>
        + nom::error::FromExternalError<&'a str, std::num::ParseIntError>
        + nom::error::FromExternalError<&'a str, std::num::ParseFloatError>
...
fn parse_level_start<'a, E>(input: &'a str) -> nom::IResult<&'a str, Message, E>
where
    E: nom::error::ParseError<&'a str>
        + nom::error::FromExternalError<&'a str, std::num::ParseIntError>,
{
...
fn parse_test_start<'a, E>(input: &'a str) -> nom::IResult<&'a str, Message, E>
where
    E: nom::error::ParseError<&'a str>
        + nom::error::FromExternalError<&'a str, std::num::ParseIntError>,
{
    let (input, _) = tag("====== TestDrive started ======")(input)?;
    Ok((input, Message::TestStart))
}

fn parse_test_finish<'a, E>(input: &'a str) -> nom::IResult<&'a str, Message, E>
where
    E: nom::error::ParseError<&'a str>
        + nom::error::FromExternalError<&'a str, std::num::ParseIntError>,
{
    let (input, _) = tag("====== TestDrive finish ======")(input)?;
    Ok((input, Message::TestFinish))
}

fn parse_spawn_player<'a, E>(input: &'a str) -> nom::IResult<&'a str, Message, E>
where
    E: nom::error::ParseError<&'a str>
        + nom::error::FromExternalError<&'a str, std::num::ParseIntError>,
{
...
fn parse_game_start<'a, E>(input: &'a str) -> nom::IResult<&'a str, Message, E>
where
    E: nom::error::ParseError<&'a str>
        + nom::error::FromExternalError<&'a str, std::num::ParseIntError>,
{
...
fn parse_round_finish<'a, E>(input: &'a str) -> nom::IResult<&'a str, Message, E>
where
    E: nom::error::ParseError<&'a str>
        + nom::error::FromExternalError<&'a str, std::num::ParseIntError>
        + nom::error::FromExternalError<&'a str, std::num::ParseFloatError>
...
fn parse_game_finish<'a, E>(input: &'a str) -> nom::IResult<&'a str, Message, E>
where
    E: nom::error::ParseError<&'a str>
        + nom::error::FromExternalError<&'a str, std::num::ParseIntError>
        + nom::error::FromExternalError<&'a str, std::num::ParseFloatError>
...
fn parse_battle_start<'a, E>(input: &'a str) -> nom::IResult<&'a str, Message, E>
where
    E: nom::error::ParseError<&'a str>
        + nom::error::FromExternalError<&'a str, std::num::ParseIntError>,
{
    let (input, _) = tag("Active battle started.")(input)?;
    Ok((input, Message::BattleStart))
}

fn parse_player_info<'a, E>(input: &'a str) -> nom::IResult<&'a str, Message, E>
where
    E: nom::error::ParseError<&'a str>
        + nom::error::FromExternalError<&'a str, std::num::ParseIntError>,
{
...
fn parse_score<'a, E>(input: &'a str) -> nom::IResult<&'a str, Message, E>
where
    E: nom::error::ParseError<&'a str>
        + nom::error::FromExternalError<&'a str, std::num::ParseIntError>
        + nom::error::FromExternalError<&'a str, parse_display::ParseError>,
...
fn parse_damage<'a, E>(input: &'a str) -> nom::IResult<&'a str, Message, E>
where
    E: nom::error::ParseError<&'a str>
        + nom::error::FromExternalError<&'a str, std::num::ParseIntError>
        + nom::error::FromExternalError<&'a str, std::num::ParseFloatError>
...
fn parse_stripe<'a, E>(input: &'a str) -> nom::IResult<&'a str, Message, E>
where
    E: nom::error::ParseError<&'a str>
        + nom::error::FromExternalError<&'a str, std::num::ParseIntError>,
{
...
fn parse_kill<'a, E>(input: &'a str) -> nom::IResult<&'a str, Message, E>
where
    E: nom::error::ParseError<&'a str>
        + nom::error::FromExternalError<&'a str, std::num::ParseIntError>,
{
...
fn parse_assist<'a, E>(input: &'a str) -> nom::IResult<&'a str, Message, E>
where
    E: nom::error::ParseError<&'a str>
        + nom::error::FromExternalError<&'a str, std::num::ParseIntError>
        + nom::error::FromExternalError<&'a str, std::num::ParseFloatError>
